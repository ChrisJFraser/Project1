...
/*
purpose : Lamp2 Project 1, home page for user to upload csv file
...
if (in_array($_FILES["fileToUpload"]["type"], $csv_mimetypes)) {
    ...
    if($check !== false) {
        echo "File is csv file - " . $check["mime"] . ".";
        $uploadOk = 1;
    } else {
...
$sql = "DELETE FROM  pt_midpoints WHERE pt_id = '".$id."'";
...
$sql = "DELETE FROM  pt_endpoints WHERE pt_id = '".$id."'";
...
$sql = "DELETE FROM  paths WHERE pt_id = '".$id."'";
...
header("Location:part1/path.php");
